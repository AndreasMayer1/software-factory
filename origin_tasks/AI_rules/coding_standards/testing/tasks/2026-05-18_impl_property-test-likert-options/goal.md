...
covers:
  ...
  sections: []
scope_description: "Backfill property test for property test likert options (REQ-PROC-002 AC-03)."
release_description: ""
...
---
# Goal: Property test likert options

## Objective

Add a `glados` property test for `LikertOptions` exercising (a) the bounded numeric range `[2, 10]` invariant, (e) the JSON round-trip, and boundary rejection below/above the range.
...
- Target type / source: `lib/core/domain/entities/questionnaire_plan_entities/likert_options.dart`
- Property-test categories covered: see Objective above.
- Generators required: any.intInRange(2, 10)
