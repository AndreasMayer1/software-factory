...
covers:
  ...
  sections: []
scope_description: "Backfill property test for property test contact (REQ-PROC-002 AC-03)."
release_description: ""
...
---
# Goal: Property test contact

## Objective

Add a `glados` property test for `Contact` exercising (a) the `scannerTier` bounded range `[1, 3]` invariant and (c) the non-empty `therapistId` and `name` string constraints.
...
- Target type / source: `lib/core/domain/entities/contact.dart`
- Property-test categories covered: see Objective above.
- Generators required: any.intInRange(1, 3), any.nonEmptyString
...
- any.intInRange(1, 3), any.nonEmptyString
