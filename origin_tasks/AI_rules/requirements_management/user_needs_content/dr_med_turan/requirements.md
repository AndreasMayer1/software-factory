...
# Requirement: Incrementally Improve Dr. med. Turan (The Rapid Monitor) Persona
...
- **Persona**: PERSONA-012 (Dr. med. Turan (The Rapid Monitor) - therapist)
- **Persona File**: `requirements_user_needs/personas/dr_med_turan/persona.md`
...
1. Create a new task in `requirements_tasks/process/AI_rules/requirements_management/user_needs_content/dr_med_turan/tasks/`
