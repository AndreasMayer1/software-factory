...
# Requirement: Incrementally Improve Michael (The High-Performer) Persona
...
- **Persona**: PERSONA-006 (Michael (The High-Performer) - self_user)
- **Persona File**: `requirements_user_needs/personas/michael_high_performer/persona.md`
...
1. Create a new task in `requirements_tasks/process/AI_rules/requirements_management/user_needs_content/michael_high_performer/tasks/`
