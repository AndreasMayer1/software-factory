...
after: [TASK-PROC-005-07]
awaiting: []
covers:
  sections: [SEC-01, SEC-02]
scope_description: "Pilot 5 - Hierarchical testing orchestrator pattern validation with further orchestrator rules adjustments"
...
This is already the 5th pilot. The orchestrator rules have been adjusted to fix some problems that were discovered by the first pilots.
